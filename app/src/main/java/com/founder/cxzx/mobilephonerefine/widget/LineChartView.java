...
public class LineChartView extends View {
    ...
    private void initPaint() {
        ...
        mYlinePaint.setColor(getContext().getResources().getColor(R.color.line_color));

        mDateLineHightPaint.setColor(getContext().getResources().getColor(R.color.line_red));
        ...
        mDateLineLowPaint.setColor(getContext().getResources().getColor(R.color.line_blue));
    ...
    private void drawDoubleLineChar(Canvas canvas) {
        ...
        for (int i = 0; i < pointData.size(); i++) {
            ...
            mTextPaint.setColor(getContext().getResources().getColor(R.color.line_red));
            mCirclePaint.setColor(getContext().getResources().getColor(R.color.white));
            mFilledCirclePaint.setColor(getContext().getResources().getColor(R.color.line_red));
            ...
            mTextPaint.setColor(getContext().getResources().getColor(R.color.line_blue));
            mCirclePaint.setColor(getContext().getResources().getColor(R.color.white));
            mFilledCirclePaint.setColor(getContext().getResources().getColor(R.color.line_blue));
            ...
            mTextPaint.setColor(getContext().getResources().getColor(R.color.word_color_light));
    ...
    private void drawLineChar(Canvas canvas) {
        mDataLinePaint.setColor(getContext().getResources().getColor(R.color.titile_blue));
        switch (mDateType) {
            case DateType_Week:
                xAddedNum = CommonUtils.Dp2Px(getContext(), 80);
                break;
        ...
        mCirclePaint.setColor(getContext().getResources().getColor(R.color.white));
        mFilledCirclePaint.setColor(getContext().getResources().getColor(R.color.titile_blue));
        ...
        for (int i = 0; i < pointData.size(); i++) {
            ...
            canvas.drawCircle(startX, startY - (value / maxValue) * mLineChartHight, circleRadius, mCirclePaint);
            mTextPaint.setColor(getContext().getResources().getColor(R.color.titile_blue));
            // canvas.drawText(value + "", startX, startY - (value / maxValue) * mLineChartHight - valueAlignBottom, mTextPaint);
            mTextPaint.setColor(getContext().getResources().getColor(R.color.word_color_light));
            //canvas.drawText("5-3", startX, mLineChartHight + cellHeight / 3, mTextPaint);
            ...
            switch (mDateType) {
                case DateType_Week:
                    int j = i + 1;
                    canvas.drawText("10-" + j, startX, mLineChartHight + cellHeight / 3, mTextPaint);
